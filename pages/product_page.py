...
class ProductPage(BasePage):
    ...
    def should_be_product_page_url(self):
        ...
        assert get_url == "http://selenium1py.pythonanywhere.com/en-gb/catalogue/coders-at-work_207/?promo=newYear2019", "Wrong link is provided to get product page"
    ...
    def is_product_name_equals_to_the_basket_product(self):
        ...
        print(name_of_product_added + '==' + name_of_product)
    ...
    def is_product_price_equals_to_the_basket_amount(self):
        ...
        print(product_price + '==' + basket_amount)
